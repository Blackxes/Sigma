...
int InitOpenGL()
{
    ...
    //
    // Read vertex shader
    std::ifstream vertexShaderStream(R"(C:\Users\black\Desktop\Game\Game\Sigma\src\shader.vert)");
    ...
    std::ifstream fragmentShaderStream(R"(C:\Users\black\Desktop\Game\Game\Sigma\src\shader.frag)");
